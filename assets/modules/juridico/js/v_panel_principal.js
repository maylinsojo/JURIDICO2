...
$(document).ready(function(){
   ...
   if(sessionStorage.getItem("ID_USUARIO") == null || typeof sessionStorage.getItem("ID_USUARIO") == 'undefined'){
	   ...
	   .html(sessionStorage.getItem("SEUDONIMO")
	         +`<img src="assets/modules/juridico/images/usuarios/`+sessionStorage.getItem("AVATAR_USUARIO")+`" height="100%" width="100%" class="img-fluid avatar">`);
...
$.fn.menu_asociado = function(){
	...
	$.ajax({
		...
		url: 'juridico/c_index/menu_usuario',
		type: 'POST',
		dataType: 'json',
		data:{
