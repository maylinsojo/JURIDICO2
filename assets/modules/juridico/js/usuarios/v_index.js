						...
						tabla += `
								  <tr>
								  	<th scope="row" class="text-center">
										<img src="../../assets/modules/juridico/images/usuarios/`+elemento.avatar+`" height="100%" width="100%" class="img-fluid avatar">
									</th>
          ...
          $('#sugerencias').addClass('show');
					...
					$(data).each(function(index, elemento){
						...
						.append(`<div id="`+elemento['id']+`" class="dropdown-item">
								  <div class="avatar">
									<img src="../../assets/modules/juridico/images/usuarios/`+elemento['avatar']+`" height="100%" width="100%">
								  </div>
