	...
	*/
	...
	$('#confirm_eliminar_ee').click(function(){
		...
		.html(`<div class="alert alert-danger" role="alert">
				 <strong>¿Esta seguro de eliminar este Establecimiento?</strong>
			...
			if(data != null){
				...
				if(data['ee'] != null && data['ee'] != ''){
					...
					$(data['ee']).each(function(index, elemento){
						...
						tabla += `<tr>
      									<td class="col-3 text-capitalize">`+elemento.nombre+`</td>
      									<td class="col-3">`+elemento.region+`</td>
      									<td class="col-2">`+elemento.comuna+`</td>
      									<td class="col-2">`+elemento.estatus+`</td>
      									<td class="col-2">
			...
			if(data != null){
				...
				.html(`<form id="form_nivel_academico">
    							<div class="row">
    								...
    								<div class="form-group col-2" data-toggle="tooltip" data-placement="top" title="N° de Estudiantes">
    									<input type="text" class="form-control" id="num_estudiantes" placeholder="N° de Estudiantes">
    									<div class="form-control-feedback text-left"></div>
    								</div>
    							</div>
                  <div class="row">
    								<div class="form-group wrapper_btn_agregar_curso col-12">
			...
			if(data['CONTACTOS'] != null){
				...
				$(data['CONTACTOS']).each(function(index, elemento){
					...
					contactos += `<tr class="contacto">
        									<td class="col-4">`+elemento.nombre+`</td>
        									<td class="telefono col-3">`+elemento.telefono+`</td>
        									<td class="telefono col-3">`+elemento.otro_telefono+`</td>
