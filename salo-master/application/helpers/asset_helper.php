...
function other_asset_url($asset_name, $module_name = NULL, $asset_type = NULL)
{
	...
	//$asset_location = 'http://desarrollo.mollynadas.com.ve/salo/assets/';
...
function less_asset_url($asset_name, $module_name = NULL)
{
	return other_asset_url($asset_name, $module_name, 'less');
}

function less_asset($asset_name, $module_name = NULL)
{  

	return '<script type="text/javascript" src="'.less_asset_url($asset_name, $module_name).'"></script>'."\n";
}
