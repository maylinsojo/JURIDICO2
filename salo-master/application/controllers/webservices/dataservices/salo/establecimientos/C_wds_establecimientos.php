...
{  
	...
	*/
	public function servicios_get(){
		...
		//Obtenemos la respuesta
		$respuesta = $this->m_wds_establecimientos->servicios();
	...
	*/
	public function servicio_establecimiento_get(){
		...
		if($validador['CODIGO_RESPUESTA'] == 1){
			...
			//Obtenemos la respuesta
			$respuesta = $this->m_wds_establecimientos->servicio_establecimiento($parametros);
	...
	*/
	public function asociar_servicio_establecimiento_post(){
		...
		if($validador['CODIGO_RESPUESTA'] == 1){
			...
			//Parametros
			$parametros['id_ee']     = $this->post('id_ee');
			$parametros['servicios'] = $this->post('servicios');
			
			//Obtenemos la respuesta
			$respuesta = $this->m_wds_establecimientos->asociar_servicio_establecimiento($parametros);
