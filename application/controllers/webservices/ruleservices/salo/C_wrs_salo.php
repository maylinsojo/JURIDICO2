...
*/
class c_wrs_salo extends REST_Controller
{  
	...
	*/
	function __construct(){
		...
		parent::__construct();
		$this->load->model('webservices/ruleservices/salo/m_wrs_salo');//Cargamos el modelo
	...
	*/
	public function login_post(){
		...
		if($validador['CODIGO_RESPUESTA'] == 1){
			...
			$respuesta = $this->m_wrs_salo->login($parametros);
