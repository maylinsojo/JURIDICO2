...
*/
class c_wds_juridico extends REST_Controller
{
	...
	*/
    ...
    $this->output->cache(0);//Para remover el cache
		$this->load->model('webservices/dataservices/juridico/m_wds_juridico');//Cargamos el modelo
	...
	*/
	public function menu_usuario_get(){
		...
		if($validador['CODIGO_RESPUESTA'] == 1){
			...
			$respuesta = $this->m_wds_juridico->menu_usuario($parametros);
