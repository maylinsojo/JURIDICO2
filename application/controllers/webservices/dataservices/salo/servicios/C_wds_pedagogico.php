...
class c_wds_pedagogico extends REST_Controller
{
	...
	*/
	public function buscar_ee_get(){
		...
		if($validador['CODIGO_RESPUESTA'] == 1){
			...
			//Obtenemos la respuesta
			$respuesta = $this->m_wds_pedagogico->buscar_ee($parametros);
	...
	*/
	public function cursosAsociados_get(){
		...
		if($validador['CODIGO_RESPUESTA'] == 1){
			...
			//Obtenemos la respuesta
			$respuesta = $this->m_wds_pedagogico->cursosAsociados($parametros);
  ...
  /*
	...
	*/
    ...
    //Obtenemos la respuesta
    $respuesta = $this->m_wds_pedagogico->imprentas();
  ...
  /*
	...
	*/
	public function producto_servicio_get(){

		//Obtenemos la respuesta
		$respuesta = $this->m_wds_pedagogico->producto_servicio();
	...
	*/
	public function nuevo_despacho_post(){
		...
		if($validador['CODIGO_RESPUESTA'] == 1){
			...
			$parametros['coste_imprenta']  = $this->post('coste_imprenta');
			$parametros['productoServ']    = $this->post('productoServ');
			$parametros['imprenta']        = $this->post('imprenta');
