...
{  
	...
	*/
	public function info_transportista_get(){
		...
		if($validador['CODIGO_RESPUESTA'] == 1){
			...
			//Obtenemos la respuesta
			$respuesta = $this->m_wds_transportistas->info_transportista($parametros);
	...
	*/
	public function estatus_transportista_get(){
		
		//Obtenemos la respuesta
		$respuesta = $this->m_wds_transportistas->estatus_transportista();
	...
	*/
	public function editar_transportista_post(){
		...
		if($validador['CODIGO_RESPUESTA'] == 1){
			...
			//Obtenemos la respuesta
			$respuesta = $this->m_wds_transportistas->editar_transportista($parametros);
	...
	*/
	public function eliminar_transportista_post(){
		...
		if($validador['CODIGO_RESPUESTA'] == 1){
			...
			//Obtenemos la respuesta
			$respuesta = $this->m_wds_transportistas->eliminar_transportista($parametros);
