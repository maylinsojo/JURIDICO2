...
class m_index extends CI_Model{
	...
	*/
    ...
    $this->baseUrlWs = "http://".$_SERVER['SERVER_NAME']."/juridico/webservices/";
	...
	*/
	public function login($parametros){
		...
		$url         = $this->baseUrlWs."ruleservices/juridico/c_wrs_juridico";
	...
	*/
	public function menu_usuario($parametros){
		...
		$url         = $this->baseUrlWs."dataservices/juridico/c_wds_juridico";
		$paramtros   = $parametros;
		$metodo_curl = 'GET';
		$metodo      = 'menu_usuario';
