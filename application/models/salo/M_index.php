...
class m_index extends CI_Model{
	...
	*/
    ...
    $this->baseUrlWs = "http://".$_SERVER['SERVER_NAME']."/salo/webservices/";
	...
	*/
	public function login($parametros){
		...
		$url         = $this->baseUrlWs."ruleservices/salo/c_wrs_salo";
	...
	*/
	public function menu_usuario($parametros){
		...
		$url         = $this->baseUrlWs."dataservices/salo/c_wds_salo";
		$paramtros   = $parametros;
		$metodo_curl = 'GET';
		$metodo      = 'menu_usuario';
