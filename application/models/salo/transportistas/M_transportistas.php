...
class m_transportistas extends CI_Model{
	...
	*/
	public function info_transportista($parametros){
		
		$url         = "http://".$_SERVER['SERVER_NAME']."/salo/webservices/dataservices/salo/transportistas/c_wds_transportistas";
		$paramtros   = $parametros;
		$metodo_curl = 'GET';
		$metodo      = 'info_transportista';
	...
	*/
	public function editar_transportista($parametros){
		
		$url         = "http://".$_SERVER['SERVER_NAME']."/salo/webservices/dataservices/salo/transportistas/c_wds_transportistas";
		$paramtros   = $parametros;
		$metodo_curl = 'POST';
		$metodo      = 'editar_transportista';
	...
	*/
	...
	/*
		Descripción : Método que elimina la transportista
		Parametros  : Nombre => id_transp , Tipo => Int, Obligatorio => Si
		Retorna     : array(
		                    CODIGO_RESPUESTA  => Int,
							MENSAJE_RESPUESTA => Varchar
	...
	*/
	public function eliminar_transportista($parametros){
		
		$url         = "http://".$_SERVER['SERVER_NAME']."/salo/webservices/dataservices/salo/transportistas/c_wds_transportistas";
		$paramtros   = $parametros;
		$metodo_curl = 'POST';
		$metodo      = 'eliminar_transportista';
