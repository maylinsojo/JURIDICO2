...
<head>
    ...
    <?php
		...
		echo css_asset('casos/v_casos.css','juridico');
		...
		echo js_asset('casos/v_casos.js','juridico');
          ...
          <form id="form_planificar">
            <div class="row">
              <div class="form-group col-12">
                <label for="establecimiento">Casos</label>
            ...
            <div class="row">
              ...
              <div class="col-6 text-left wrapper_btn_desp">
                <button id="guardar_caso" type="button" class="btn btn-success">Despachar</button>
              </div>
            </div>
          </form>
        </div>
