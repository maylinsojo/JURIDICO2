...
<head>
    ...
    echo css_asset('treed.css','treed');
	  ...
	  echo css_asset('establecimientos/v_index.css','salo');
    ...
    echo js_asset('bootstrap.min.js','bootstrap-4.0.0/dist');
	  ...
	  echo js_asset('establecimientos/v_index.js','salo');
            ...
            <div class="row">
              <div class="col-6">
                <div class="input-group dropdown">
                  <input type="text" class="form-control" id="busc_nombre_ee" placeholder="Nombre del establecimiento" autocomplete="off">
              ...
              <div class="col-6 text-right">
         	    	<button id="nuevo_establecimiento" type="button" class="btn btn-success">Crear Establecimiento</button>
              </div>
            </div>
          </nav>
          <div class="col col-12 wrapper_ee"></div>
          <div class="col col-11 wrapper_paginador"></div>
        </div>
      </div>
    </div><!-- Fin .container -->
