...
<head>
    ...
    echo css_asset('treed.css','treed');
	  ...
	  echo css_asset('comunas/v_index.css','salo');
    ...
    echo js_asset('bootstrap.min.js','bootstrap-4.0.0/dist');
	  ...
	  echo js_asset('comunas/v_index.js','salo');
...
<body>
   <div class="container">
    	<div class="row align-items-center justify-content-center">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                             ...
                             <div class="input-group dropdown">
                                ...
                                <input type="text" class="form-control" id="busc_nombre_com" placeholder="Nombre de la comuna" autocomplete="off">
                        ...
                        <div class="col-6 text-right">
                   	    	...
                   	    	<button id="nueva_comuna" type="button" class="btn btn-success">Crear Comuna</button>
            ...
            <div class="col col-sm-11 wrapper_comunas"></div>
