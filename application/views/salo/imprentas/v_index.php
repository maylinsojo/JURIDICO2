...
<head>
    ...
    echo css_asset('treed.css','treed');
	  ...
	  echo css_asset('imprentas/v_index.css','salo');
    ...
    echo js_asset('bootstrap.min.js','bootstrap-4.0.0/dist');
	  ...
	  echo js_asset('imprentas/v_index.js','salo');
            ...
            <div class="row">
              <div class="col-6">
                 <div class="input-group dropdown">
                    <input type="text" class="form-control" id="busc_nombre_imp" placeholder="Nombre de la imprenta" autocomplete="off">
              ...
              <div class="col-6 text-right">
         	    	<button id="nueva_imprenta" type="button" class="btn btn-success">Crear Imprenta</button>
              </div>
            </div>
          </nav><!-- Fin navbar -->
        </div>
        <div class="col col-sm-11 wrapper_imprentas"></div>
